    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="<%=path %>/admin.do?method=goAdminUserTable" title="Sample page 1">查看用户</a>
                </li>
                <li class="pull-right">
                        ...
                        <div class="nest" id="FilteringClose">
                            ...
                            <div class="body-nest" id="Filtering">
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="10">
                                    ...
                                    <tbody>
                                    <%
	                                  if(!departmentName.equals("所有用户") && !departmentName.equals("管理员")){ 
	                                    for(User user2: userList){ 
	                                    		Date date = new Date(Long.parseLong(user2.getDate()));
	                                    		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); 
	                                    		
                                    %>
                                        <tr>
                                            <td><%=user2.getName() %></td>
                                            <td><%=user2.getTruename() %>
                                            <td><%=sdf.format(date) %></td>
                                            	<td><a href="<%=path%>/admin.do?method=goAdminUserTable&id=<%=user2.getId()%>">删除</a></td>
                                            <td><%=user2.getPwd() %></td>
                                            <td data-value="78025368997"><%=user2.getPhone() %></td>
                                            <td data-value="1">
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><%=user2.getTruename() %>
                                            <td><%=sdf.format(date) %></td>
                                            	<td><a href="<%=path%>/admin.do?method=goAdminUserTable&id=<%=user2.getId()%>&action=deleteUser">删除</a> &nbsp&nbsp&nbsp&nbsp<a href="<%=path%>/admin.do?method=goAdminUpdateUser&id=<%=user2.getId()%>">修改</a></td>
                                            <td><%=user2.getPwd() %></td>
                                            <td data-value="78025368997"><%=user2.getPhone() %></td>
                                            <td data-value="1">
                                                <span class="status-metro status-active" title="Active">正常</span>
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><%=user2.getTruename() %>
                                            <td><%=sdf.format(date) %></td>
                                            	<td><a href="<%=path%>/admin.do?method=goAdminTable&id=<%=user2.getId()%>&action=deleteUser">删除</a></td>
                                            <td><%=user2.getPwd() %></td>
                                            <td data-value="78025368997"><%=user2.getPhone() %></td>
                                            <td data-value="1">
                                                <span class="status-metro status-active" title="Active">正常</span>
