    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="<%=path %>/admin.do?method=goAdminDepartmentAddUser&departmentId=<%=department.getId() %>" title="Sample page 1">查看用户</a>
                </li>
                <li class="pull-right">
                    ...
                    <div class="col-sm-12">
                        <div class="nest" id="FilteringClose">
                            <div class="title-alt">
							 ...
							 <form action="<%=path %>/admin.do?method=adminDepartmentAddUser" method="post" class="form-horizontal bucket-form">
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><%=user2.getTruename() %>
                                            	<td><input tabindex="13" type="checkbox" name="choice" value="<%=user2.getId() %>" id="<%=user2.getId() %>"></td>
                                            <td data-value="78025368997"><%=sdf.format(date) %></td>
							...
							<div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="form-control-static"><button class="btn btn-success" type="submit">添加</button>
                                                </p>
                                            </div>
                                        </div>
