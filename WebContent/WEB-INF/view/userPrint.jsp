...
List<Rtp> topRtps = (List<Rtp>) request.getAttribute("topRtps");
                        ...
                        <div class="nest" id="elementClose">
                            ...
                            <div class="body-nest" id="element">
                                ...
                                <div class="panel-body">
                                    <form action="<%=path %>/webuser.do?method=goUserReport" method="post" class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="form-control-static"><%=contract.getContractId() %>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="form-control-static"><%=contract.getName() %>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="form-control-static"><%=contract.getCompany() %>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="form-group">
						                                ...
						                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="10">
						                                    ...
						                                    <%for(Property property : propertys){ 
						                                    		...
						                                    		if(property.getStatus().equals("1")){
						                                    			tempStatus = "开启中";
						                                    			tempValue = "status-metro status-active";
						                                    		} else if(property.getStatus().equals("2")){
						                                    			tempStatus = "已停止";
						                                    			tempValue = "status-metro status-suspended";
						                                    		} else if(property.getStatus().equals("0")){
						                                    			tempStatus = "已删除";
						                                    			tempValue = "status-metro status-disabled";
						                                    		}
						                                    %>
						                                        <tr>
						                                            <td>
						                                            		
					                                                    	<input tabindex="13" type="checkbox" name="choice" value="<%=property.getPropertyId() %>" id="<%=property.getId() %>">
						                                            		
						                                            		<%=property.getPropertyId() %>
					                                            		</td>
						                                            <td><%=property.getName() %></td>
						                                            
						                                            <td data-value="78025368997"><%=property.getRemark() %></td>
						                                            <td data-value="1">
						                                                <span class="<%=tempValue %>" title="Active"><%=tempStatus %></span>
						                                            </td>
						                                        </tr>
						                                    <%} %>
						                                        <!-- <tr>
						                                            ...
						                                            <td>
						                                            		<li>
					                                                    <input tabindex="13" type="checkbox" id="flat-checkbox-2">
