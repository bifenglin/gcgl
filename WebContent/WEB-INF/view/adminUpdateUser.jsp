                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    ...
                                    <form action="<%=path %>/admin.do?method=goAdminUserTable&action=update&id=<%=targetUser.getId() %>" id="contact-form" class="form-horizontal" method="post">
                                        <fieldset>
                                            <div class="control-group">
                                                <label class="control-label" for="name">帐号</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="name" id="name" value="<%=targetUser.getName() %>">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="truename">姓名</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="truename" id="truename" value="<%=targetUser.getTruename() %>">
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="pwd">密码</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="pwd" id="pwd" value="<%=targetUser.getPwd() %>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="phone" id="phone" value="<%=targetUser.getPhone() %>">
                                                </div>
                                            </div>
                                        		<div class="control-group">
                                                <label class="control-label" for="remark">备注</label>
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="remark" id="remark" value="<%=targetUser.getRemark() %>">
                                                </div>
                                            </div>
