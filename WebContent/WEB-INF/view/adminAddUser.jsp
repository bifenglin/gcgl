                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    ...
                                    <form action="<%=path %>/admin.do?method=goA" id="contact-form" class="form-horizontal" method="post">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
			                                    ...
			                                    <div class="controls">
			                                            ...
			                                            <%for(int i=0; i<departments.size(); i++){ 
			                                            		...
			                                            		if(i == 0){
			                                            %>
			                                                <option value="<%=department.getName() %>" selected="selected"><%=department.getName() %>
			                                                <%}else{ %>
