...
List<ContractStowage> contractStowages = (List)request.getAttribute("contractStowages");
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">合同库管理</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="<%=path %>/admin.do?method=goAdminCheckContractStowage" title="Sample page 1">查看所有合同库</a>
                </li>
                <li class="pull-right">
                            ...
                            <div class="col-sm-12">
                                <div class="col-xs-12 col-sm-8 profile-name">
                                    ...
                                    <dl class="dl-horizontal-profile">
                                        ...
                                        <dt>机械</dt>
                                        <dd>使用:<%=count.get("machineOn") %></dd>
										<dd>黑名单<%=count.get("machineOff") %></dd>
                                        <dt>劳务</dt>
                                        <dd>使用:</dd>
										<dd>黑名单<%=count.get("labourOff") %></dd>
										</div>
										<div class="col-xs-12 col-sm-6">
                                        <dt>材料</dt>
                                        <dd>使用:</dd>
										<dd>黑名单<%=count.get("materialOff") %></dd>
                                        <dt>其他</dt>
                                        <dd>使用:<%=count.get("otherOn") %></dd>
										<dd>黑名单<%=count.get("otherOff") %></dd>
										</div>
                                    </dl>
                                    <hr>
                                    </div>
                    ...
                    <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="col-xs-12 col-sm-2 text-center">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item text-left">
                                            <span class="entypo-user"></span>&nbsp;&nbsp;统计</li>
                                        ...
                                        <li class="list-group-item text-right">
                                            <span class="pull-left">
                                                <strong>总数</strong>
                                            </span><%=count.get("allOn") %></li>
                                        <li class="list-group-item text-right">
                                            <span class="pull-left">
                                                <strong>总黑名单</strong>
                                            </span><%=count.get("allOff") %></li>
                                    </ul>

                                </div>
                                <div class="col-xs-12 col-sm-5 profile-name">
                                    <h2>合格供方库
                                    </h2>
                                    <hr>
                                    ...
                                    <dl class="dl-horizontal-profile">
                                        <dt>机械</dt>
                                        <dd><%=count.get("machineOn") %></dd>

                                        <dt>劳务</dt>
                                        <dd><%=count.get("labourOn") %></dd>

                                        <dt>材料</dt>
                                        <dd><%=count.get("materialOn") %></dd>

                                        <dt>其他</dt>
                                        <dd><%=count.get("otherOn") %></dd>
                                ...
                                <div class="col-xs-12 col-sm-5 profile-name">
                                    ...
                                    <dl class="dl-horizontal-profile">
                                        <dt>机械</dt>
                                        <dd><%=count.get("machineOff") %></dd>

                                        <dt>劳务</dt>
                                        <dd><%=count.get("labourOff") %></dd>

                                        <dt>材料</dt>
                                        <dd><%=count.get("materialOff") %></dd>

                                        <dt>其他</dt>
                                        <dd><%=count.get("otherOff") %></dd>
                        ...
                        <div class="nest" id="FilteringClose">
                            ...
                            <div class="body-nest" id="Filtering">
                                ...
                                <table id="footable-res2" class="demo" data-filter="#filter" data-filter-text-only="true" data-page-size="10">
                                    ...
                                    <tbody>
                                    <%
                                    if(contractStowages!=null){
	                                    for(ContractStowage contractStowage: contractStowages){ 
	                                    		Date date = new Date(Long.parseLong(contractStowage.getDate()));
	                                    		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); 
	                                    		String value = null;
	                                    		String key = contractStowage.getType();
	                                    		if (key.equals(TypeEnum.LABOUR.getKey())) {
	                                    			value = TypeEnum.LABOUR.getValue();
	                                    		} else if(key.equals(TypeEnum.MACHINE.getKey())) {
	                                    			value = TypeEnum.MACHINE.getValue();
	                                    		} else if(key.equals(TypeEnum.MATERIAL.getKey())) {
	                                    			value = TypeEnum.MATERIAL.getValue();
	                                    		} else if(key.equals(TypeEnum.OTHER.getKey())) {
	                                    			value = TypeEnum.OTHER.getValue();
	                                    		} else if(key.equals(TypeEnum.PEOPLE.getKey())) {
	                                    			value = TypeEnum.PEOPLE.getValue();
	                                    		}  
                                    %>
                                        <tr>
                                            <td><%=contractStowage.getName() %></td>
                                            <td><%=value %></td>
                                            <td><%=contractStowage.getCompany() %>
                                            <td><%=sdf.format(date) %></td>
                                            <%
                                            if(contractStowage.getStatus().endsWith("1")){
                                            	%>
                                            		<td><a href="<%=path%>/admin.do?method=goAdminCheckContractStowage&type=join&id=<%=contractStowage.getId()%>">加入黑名单</a></td>
	                                            	 <td data-value="1">
	                                                 <span class="status-metro status-active" title="Active">正常</span>
	                                             </td>
                                             <% 
		                                    		} else{
                                   			%>
                                   				<td><a href="<%=path%>/admin.do?method=goAdminCheckContractStowage&type=delete&id=<%=contractStowage.getId()%>">删除</a></td>
	                                           	 <td data-value="1">
	                                                <span class="status-metro status-disabled" title="disabled">黑名单</span>
	                                            	 </td>
                                            <% 
		                                    		}
                                            %>
                                            <td><%=contractStowage.getTimes() %></td>
                                           	<td data-value="78025368997"><%=contractStowage.getAllAverage() %></td>
                                            <td data-value="78025368997"><%=contractStowage.getAllManage() %></td>
                                            <td data-value="78025368997"><%=contractStowage.getAllTechnology() %></td>
                                            <td data-value="78025368997"><%=contractStowage.getAllFund() %></td>
                                        </tr>
                                      <%}
                                    }
                                      %>
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td>删除</td>
                                            <td>2016－01-01</td>
                                            <td data-value="78025368997">15820034791</td>
                                            <td data-value="1">
                                                <span class="status-metro status-active" title="Active">正常</span>
                                            </td>
                                        </tr> -->
